...
<body>
	...
	<table style="margin-top: 20px" id="myTable">
		<tr class="title">
			...
			<th style="background: #555; color: #ddd;text-align: center;">TỔNG TIỀN</th>
			<th style="background: #555; color: #ddd;text-align: center;">NGÀY LẬP</th>
		...
		<c:forEach var="s" items="${orders}" varStatus="status">	
			<tr>
				...
				<td style="text-align: center;"> ${ s.total}</th>
				<td style="text-align: center;"> ${ s.createdAtDate}</th>
				<td><a href="admin/orders/detail/${s.id}.htm">View detail</a></td>
			</tr>
		</c:forEach>
